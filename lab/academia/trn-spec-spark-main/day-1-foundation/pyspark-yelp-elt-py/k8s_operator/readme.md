...
http://143.244.222.138:9090/

# minio configuration [endpoint]
mc config host add minio 143.244.222.138:9090/ 4SxTgRcCkLxkiBbo UVwS3GwoASorqog0MwUqXSOaYcTywrSB
...
```sh
# location = /trn-spec-spark/day-1-foundation/pyspark-yelp-elt-py/k8s_operator
...
k apply -f /Users/luanmorenomaciel/GitHub/trn-spec-spark/day-1-foundation/pyspark-yelp-elt-py/k8s_operator/crb-spark-operator-processing.yaml -n processing
...
# [deploy application]
kubens processing
k apply -f /Users/luanmorenomaciel/GitHub/trn-spec-spark/day-1-foundation/pyspark-yelp-elt-py/k8s_operator/batch-etl-yelp-py.yaml -n processing
